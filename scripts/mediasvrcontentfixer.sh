...
mediadir2='/data2/plexmediaserver'
mediadir3='/data4/plexmediaserver'
torrentsdir='/data4/torrents'

# Fixes ownership issues
chown -R plex:media $mediadir $mediadir2 $mediadir3
chown -R transmission:media $torrentsdir

# Removes junk type files from media folders
find $mediadir/{movies,tvshows} -type f \( -iname "*.html" -o -iname "*.smi" -o -iname "*.srt.random-*" -o -iname "*.dbm" -o -iname "*.website" -o -iname "*.url" -o -iname "*.txt" -o -iname "*.nfo*" -o -iname "*.ignore" -o -iname "*.db" -o -iname "*.nzb" -o -iname "*.part" -o -iname "*.added" -o -iname "*.jpg" -o -iname "*.jpeg" -o -iname "*.png" -o -iname "*.gif" -o -iname "*.par2" -o -iname "*.part" -o -iname "*.srr" -o -iname "*.sfv" -o -iname "*.rar" -o -iname "*.r[0-9][0-9]" \) -exec rm -f {} \;
find $mediadir2/{movies,tvshows} -type f \( -iname "*.html" -o -iname "*.smi" -o -iname "*.srt.random-*" -o -iname "*.dbm" -o -iname "*.website" -o -iname "*.url" -o -iname "*.txt" -o -iname "*.nfo*" -o -iname "*.ignore" -o -iname "*.db" -o -iname "*.nzb" -o -iname "*.part" -o -iname "*.added" -o -iname "*.jpg" -o -iname "*.jpeg" -o -iname "*.png" -o -iname "*.gif" -o -iname "*.par2" -o -iname "*.part" -o -iname "*.srr" -o -iname "*.sfv" -o -iname "*.rar" -o -iname "*.r[0-9][0-9]" \) -exec rm -f {} \;
find $mediadir3/{movies,tvshows} -type f \( -iname "*.html" -o -iname "*.smi" -o -iname "*.srt.random-*" -o -iname "*.dbm" -o -iname "*.website" -o -iname "*.url" -o -iname "*.txt" -o -iname "*.nfo*" -o -iname "*.ignore" -o -iname "*.db" -o -iname "*.nzb" -o -iname "*.part" -o -iname "*.added" -o -iname "*.jpg" -o -iname "*.jpeg" -o -iname "*.png" -o -iname "*.gif" -o -iname "*.par2" -o -iname "*.part" -o -iname "*.srr" -o -iname "*.sfv" -o -iname "*.rar" -o -iname "*.r[0-9][0-9]" \) -exec rm -f {} \;
...
#find $torrentsdir/downloaded/* -empty -exec rm -rf {} \;
...
find $mediadir2/{movies,tvshows} -type f ! -perm 0640 -exec chmod 640 {} \;
find $mediadir2/{movies,tvshows} -type d ! -perm 0770 -exec chmod 770 {} \;
find $mediadir3/{movies,tvshows} -type f ! -perm 0640 -exec chmod 640 {} \;
find $mediadir3/{movies,tvshows} -type d ! -perm 0770 -exec chmod 770 {} \;

# Fixes permissions on main directories
#chmod 770 $mediadir $mediadir2 $torrentsdir $mediadir3
